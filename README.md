...
* **expo-local-authentication** & **expo-secure-store** for biometric authentication and secure store
* **react-native-paper** for light/dark mode support
...
```bash
git clone https://github.com/yash-8-bit/lockIt.git
cd lockIt
````
...
This will open a page in your browser with a QR code. Scan it using the **Expo Go** app to run it on your mobile device.
